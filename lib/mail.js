...
<body>
    ...
    <div class="container">
        <div class="header">
          <img src="${serverConfig.nextUrl}/member/otpmail_images/BARKBIJOU_horizontal.png" alt="Company Logo" width="150">
            <h1 style="color: #ffffff;">重設登入密碼的一次性驗證碼(OTP)</h1>
        </div>
        <div class="content">
            <p>親愛的網站會員 您好，</p>
...
<http://http://localhost:3000/forgetpassword/reset?secret=${secret}>
