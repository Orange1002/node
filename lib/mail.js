...
<head>
    ...
    <title>重設網站登入密碼要求的一次性驗證碼 OTP Verification</title>
    <style>
        body {
    ...
    <div class="container">
        <div class="header">
          <p class="BARK">BARK & BIJOU</p>
            <h1 style="color: #ffffff;">重設密碼 - 一次性驗證碼(OTP)</h1>
        </div>
        <div class="content">
            <p>親愛的BARK & BIJOU會員 您好，</p>
            <p>您的一次性驗證碼(OTP code)如下:</p>
            <div class="otp-code">${otpToken}</div>
            <p>請在您目前的重設登入密碼頁面中的"一次性驗證碼"輸入框進行輸入。或是從以下的連結連入頁面:</p>
            <p><a href="${serverConfig.nextUrl}/forgetpassword/resetpassword?secret=${secret}" target="_blank">重設密碼頁面連結</a></p>
...
<http://http://localhost:3000/forgetpassword/resetpassword?secret=${secret}>
